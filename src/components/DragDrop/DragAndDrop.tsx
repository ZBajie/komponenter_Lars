      ...
      <div className="BoxContainer">
        <div id="box1" onDragOver={handleDragOver} onDrop={handleDrop}>
          <input
            type="text"
            value={boxNames.box1}
            onChange={(e) => handleNameChange(e, "box1")}
          />
          {(data.items as ItemType[]).map((item: ItemType, index: number) => (
            <li
              ...
              title={`${item.description}, ${item.type}, ${item.rarity}, Attack: ${item.stats.attack}, Defense: ${item.stats.defense}`}
        ...
        <div id="box2" onDragOver={handleDragOver} onDrop={handleDrop}>
          <input
            type="text"
            value={boxNames.box2}
            onChange={(e) => handleNameChange(e, "box2")}
          />
        </div>
        <div id="box3" onDragOver={handleDragOver} onDrop={handleDrop}>
          <input
            type="text"
            value={boxNames.box3}
            onChange={(e) => handleNameChange(e, "box3")}
          />
        </div>
      </div>
    </>
